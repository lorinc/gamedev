// Every number b3 is tuned with. The dev panel edits this object live; presets are copies of it.
...
// The zoom levels (D050): tile sizes in device px where the backpack draws pixel-exact. Nothing in between.
export const ZOOM_PX = [10, 12, 14, 16, 17, 18, 20, 24, 30, 40, 48]
export const AUTO_TILES = 24 // the default zoom: the level closest to this many tiles across the short side
