...
- Scale steps take any integer, separately for X and Y.
- The recipe and its render were archived as `archive/2026-09-24_starter-caves_seed6712.*`, and are copied here as `media/`.
- v2 was frozen. v3 was built as a new tool on top of it, following the rule "new ideas become a new version".
