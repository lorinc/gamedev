...
build b1.6: 2026-09-25 · Ruleset b1.6: planks, asking first, fewer stops (D039–D043); a yes covers only its kind of action (D044); the crossing stop (D045)
build b1.7: 2026-09-25 · Flick and hold: a flick follows the world, a hold goes straight and builds (D046, D047); hold check 0.2 s (D048); the crossing stop reaches the game
---
