...
export function rulesetMarkdown(r) {
  ...
  out.push(
    '',
    '**Stop rules** (a run of steps goes on until one fires; a refusal always stops, but a `noRock` / `packFull` refusal mid-run gives way to the stop the run would have made anyway, D030):',
    '',
